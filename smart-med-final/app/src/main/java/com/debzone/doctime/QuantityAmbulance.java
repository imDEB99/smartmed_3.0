...
public class QuantityAmbulance extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quantity_ambulance);
            ...
            Button buyNowButton = findViewById(R.id.buy_now_button_ambulance);
            ...
            buyNowButton = findViewById(R.id.buy_now_button_ambulance);
            buyNowButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    int perPrice = 1500; // Per price in taka
                    int totalPrice = perPrice * quantity;

                    // Show a dialog to confirm the purchase
                    AlertDialog.Builder builder = new AlertDialog.Builder(QuantityAmbulance.this);
                    ...
                    builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            Intent intent = new Intent(QuantityAmbulance.this, Payment.class);
