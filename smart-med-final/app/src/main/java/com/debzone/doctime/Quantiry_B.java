...
public class Quantiry_B extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quantiry_b);
        ...
        buyNowButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int perPrice = 1; // Per price in taka
                int totalPrice = perPrice * quantity;

                // Show a dialog to confirm the purchase
                AlertDialog.Builder builder = new AlertDialog.Builder(Quantiry_B.this);
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(Quantiry_B.this, Payment.class);
