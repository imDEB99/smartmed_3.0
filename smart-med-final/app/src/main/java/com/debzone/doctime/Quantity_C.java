...
public class Quantity_C extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quantity_c);
        ...
        buyNowButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int perPrice = 100; // Per price in taka
                int totalPrice = perPrice * quantity;

                // Show a dialog to confirm the purchase
                AlertDialog.Builder builder = new AlertDialog.Builder(Quantity_C.this);
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(Quantity_C.this, Payment.class);
