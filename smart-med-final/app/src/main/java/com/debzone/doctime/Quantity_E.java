...
public class Quantity_E extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quantity_e);
        ...
        buyNowButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int perPrice = 8; // Per price in taka
                int totalPrice = perPrice * quantity;

                // Show a dialog to confirm the purchase
                AlertDialog.Builder builder = new AlertDialog.Builder(Quantity_E.this);
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(Quantity_E.this, Payment.class);
